 ...
 * @author marti
 */
public class Facturas_Clientes_Implements implements Facturas_ClientesDao {
    ...
    public void ExtraerFactura(Entidad_Facturav e) {
        String sql = "SELECT id_cliente ,fecha , forma_pago ,idFacturav FROM facturav where id_cliente=?";
        Connection conn = null;
        ...
        try {
            ...
            if (consulta.next()) {
                ...
                e.setIdcliente(Integer.parseInt(consulta.getString("id_cliente")));
                e.setFecha(consulta.getDate("fecha"));
                e.setFormapago(consulta.getString("forma_pago"));
                e.setIdfactura(Integer.parseInt(consulta.getString("idFacturav")));
    ...
    public void ExtraerTabla(JTable a, Entidad_Facturav p, Entidad_DetalleFactura fv) {
        ...
        String sql = "SELECT idFactura  ,  id_cliente  , id_producto ,descripcion,cantidad,precio FROM facturav   , detallefactura  where  id_cliente=? and idfacturav= idFactura ";
