...
import ImplementacionDao.inventarioProductos_Implements;
 ...
 * @author marti
 */
public class StockInventario extends javax.swing.JFrame {
    ...
    public void Extraer() {
        inventario_productosDao d = new inventarioProductos_Implements();
        d.ExtraerProductoBD(jTable1);
//        Entidad_EntradaProductos ee = new Entidad_EntradaProductos();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod. Producto", "Descripcion", "Entradas", "Salidas", "Existencias iniciales", "Stock"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockInventario().setVisible(true);
            }
        });
    }
